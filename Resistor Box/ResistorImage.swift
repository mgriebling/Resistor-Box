...
//  ResistorBox
//
//  Created by Mike Griebling on 30 Mar 2018.
...
public class ResistorImage : NSObject {
    ...
    @objc dynamic public class func drawSeriesResistors(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 416, height: 109), resizing: ResizingBehavior = .aspectFit, topGradientColor: UIColor = UIColor(red: 0.929, green: 0.520, blue: 0.520, alpha: 1.000), value1: String = "11.1K", value2: String = "22.2K", value3: String = "33.3K", label: String = "Maraschino") {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        let topGradient = CGGradient(colorsSpace: nil, colors: [UIColor.white.cgColor, UIColor.white.blended(withFraction: 0.5, of: topGradientColor).cgColor, topGradientColor.cgColor] as CFArray, locations: [0, 0.48, 1])!
    ...
    @objc dynamic public class func drawSeriesParallelResistors(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 359, height: 169), resizing: ResizingBehavior = .aspectFit, midGradientColor: UIColor = UIColor(red: 0.719, green: 0.719, blue: 1.000, alpha: 1.000), value1: String = "11.1K", value2: String = "22.2K", value3: String = "33.3K", label: String = "Maraschino") {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Gradient Declarations
        let midGradient = CGGradient(colorsSpace: nil, colors: [UIColor.white.cgColor, midGradientColor.cgColor] as CFArray, locations: [0, 1])!
    ...
    @objc dynamic public class func drawParallelResistors(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 391, height: 235), resizing: ResizingBehavior = .aspectFit, bottomGradientColor: UIColor = UIColor(red: 0.519, green: 0.979, blue: 0.519, alpha: 1.000), value1: String = "11.1K", value2: String = "22.2K", value3: String = "33.3K", label: String = "Maraschino") {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Gradient Declarations
        let bottomGradient = CGGradient(colorsSpace: nil, colors: [UIColor.white.cgColor, bottomGradientColor.cgColor] as CFArray, locations: [0, 1])!
    ...
    @objc dynamic public class func drawVoltageDivider(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 354, height: 207), resizing: ResizingBehavior = .aspectFit, topGradientColor: UIColor = UIColor(red: 0.929, green: 0.520, blue: 0.520, alpha: 1.000), value1: String = "11.1K", value2: String = "22.2K", value3: String = "33.3K", label: String = "Maraschino") {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawOpAmpGain(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 416, height: 196), resizing: ResizingBehavior = .aspectFit, midGradientColor: UIColor = UIColor(red: 0.719, green: 0.719, blue: 1.000, alpha: 1.000), value1: String = "11.1K", value2: String = "22.2K", value3: String = "33.3K", label: String = "Maraschino") {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        polygonPath.addLine(to: CGPoint(x: 5.76, y: 77.62))
        polygonPath.close()
        UIColor.black.setStroke()
    ...
    @objc dynamic public class func drawOpAmpGain2(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 417, height: 206), resizing: ResizingBehavior = .aspectFit, topGradientColor: UIColor = UIColor(red: 0.929, green: 0.520, blue: 0.520, alpha: 1.000), value1: String = "11.1K", value2: String = "22.2K", value3: String = "33.3K", label: String = "Maraschino") {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawVoltageDivider2(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 354, height: 208), resizing: ResizingBehavior = .aspectFit, midGradientColor: UIColor = UIColor(red: 0.719, green: 0.719, blue: 1.000, alpha: 1.000), value1: String = "11.1K", value2: String = "22.2K", value3: String = "33.3K", label: String = "Maraschino") {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawPowerSupply(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 380, height: 202), resizing: ResizingBehavior = .aspectFit, topGradientColor: UIColor = UIColor(red: 0.929, green: 0.520, blue: 0.520, alpha: 1.000), value1: String = "11.1K", value2: String = "22.2K", value3: String = "33.3K", label: String = "Maraschino") {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// V * x 2 Drawing
        let vX2Rect = CGRect(x: 339, y: 27, width: 25, height: 28)
        ...
        //// V * x Drawing
        let vXRect = CGRect(x: 184, y: 28, width: 25, height: 27)
        let vXTextContent = "V₊"
        let vXStyle = NSMutableParagraphStyle()
        vXStyle.alignment = .center
        let vXFontAttributes = [
    ...
    @objc dynamic public class func drawPowerSupply2(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 380, height: 249), resizing: ResizingBehavior = .aspectFit, midGradientColor: UIColor = UIColor(red: 0.719, green: 0.719, blue: 1.000, alpha: 1.000), value1: String = "11.1K", value2: String = "22.2K", value3: String = "33.3K", label: String = "Maraschino") {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// V * x 4 Drawing
        let vX4Rect = CGRect(x: 177, y: 26, width: 25, height: 27)
        ...
        //// V * x 7 Drawing
        let vX7Rect = CGRect(x: 336, y: 26, width: 25, height: 28)
        let vX7TextContent = "V₀"
        let vX7Style = NSMutableParagraphStyle()
        vX7Style.alignment = .center
        let vX7FontAttributes = [
            .font: UIFont(name: "HelveticaNeue-Bold", size: 24)!,
            .foregroundColor: UIColor.black,
            .paragraphStyle: vX7Style,
        ] as [NSAttributedStringKey: Any]

        let vX7TextHeight: CGFloat = vX7TextContent.boundingRect(with: CGSize(width: vX7Rect.width, height: CGFloat.infinity), options: .usesLineFragmentOrigin, attributes: vX7FontAttributes, context: nil).height
        context.saveGState()
        context.clip(to: vX7Rect)
        vX7TextContent.draw(in: CGRect(x: vX7Rect.minX, y: vX7Rect.minY + (vX7Rect.height - vX7TextHeight) / 2, width: vX7Rect.width, height: vX7TextHeight), withAttributes: vX7FontAttributes)
        context.restoreGState()
    ...
    @objc dynamic public class func drawGradientButton(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 130, height: 40), resizing: ResizingBehavior = .aspectFit, selectedGradientColor: UIColor = UIColor(red: 0.288, green: 0.923, blue: 0.352, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 130, height: 40), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 130, y: resizedFrame.height / 40)
        ...
        //// Rectangle Drawing
        let rectanglePath = UIBezierPath(roundedRect: CGRect(x: 2, y: 2, width: 126, height: 35), cornerRadius: 4)
        context.saveGState()
        rectanglePath.addClip()
        context.drawLinearGradient(selectedGradient, start: CGPoint(x: 65, y: 2), end: CGPoint(x: 65, y: 37), options: [])
        context.restoreGState()
        UIColor.gray.setStroke()
        rectanglePath.lineWidth = 2
        rectanglePath.stroke()
    ...
    @objc dynamic public class func imageOfSeriesResistors(topGradientColor: UIColor = UIColor(red: 0.929, green: 0.520, blue: 0.520, alpha: 1.000), value1: String = "11.1K", value2: String = "22.2K", value3: String = "33.3K", label: String = "Maraschino") -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 416, height: 109), false, 0)
            ResistorImage.drawSeriesResistors(topGradientColor: topGradientColor, value1: value1, value2: value2, value3: value3, label: label)
    ...
    @objc dynamic public class func imageOfSeriesParallelResistors(midGradientColor: UIColor = UIColor(red: 0.719, green: 0.719, blue: 1.000, alpha: 1.000), value1: String = "11.1K", value2: String = "22.2K", value3: String = "33.3K", label: String = "Maraschino") -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 359, height: 169), false, 0)
            ResistorImage.drawSeriesParallelResistors(midGradientColor: midGradientColor, value1: value1, value2: value2, value3: value3, label: label)
    ...
    @objc dynamic public class func imageOfParallelResistors(bottomGradientColor: UIColor = UIColor(red: 0.519, green: 0.979, blue: 0.519, alpha: 1.000), value1: String = "11.1K", value2: String = "22.2K", value3: String = "33.3K", label: String = "Maraschino") -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 391, height: 235), false, 0)
            ResistorImage.drawParallelResistors(bottomGradientColor: bottomGradientColor, value1: value1, value2: value2, value3: value3, label: label)
    ...
    @objc dynamic public class func imageOfVoltageDivider(topGradientColor: UIColor = UIColor(red: 0.929, green: 0.520, blue: 0.520, alpha: 1.000), value1: String = "11.1K", value2: String = "22.2K", value3: String = "33.3K", label: String = "Maraschino") -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 354, height: 207), false, 0)
            ResistorImage.drawVoltageDivider(topGradientColor: topGradientColor, value1: value1, value2: value2, value3: value3, label: label)
    ...
    @objc dynamic public class func imageOfOpAmpGain(midGradientColor: UIColor = UIColor(red: 0.719, green: 0.719, blue: 1.000, alpha: 1.000), value1: String = "11.1K", value2: String = "22.2K", value3: String = "33.3K", label: String = "Maraschino") -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 416, height: 196), false, 0)
            ResistorImage.drawOpAmpGain(midGradientColor: midGradientColor, value1: value1, value2: value2, value3: value3, label: label)
    ...
    @objc dynamic public class func imageOfOpAmpGain2(topGradientColor: UIColor = UIColor(red: 0.929, green: 0.520, blue: 0.520, alpha: 1.000), value1: String = "11.1K", value2: String = "22.2K", value3: String = "33.3K", label: String = "Maraschino") -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 417, height: 206), false, 0)
            ResistorImage.drawOpAmpGain2(topGradientColor: topGradientColor, value1: value1, value2: value2, value3: value3, label: label)
    ...
    @objc dynamic public class func imageOfVoltageDivider2(midGradientColor: UIColor = UIColor(red: 0.719, green: 0.719, blue: 1.000, alpha: 1.000), value1: String = "11.1K", value2: String = "22.2K", value3: String = "33.3K", label: String = "Maraschino") -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 354, height: 208), false, 0)
            ResistorImage.drawVoltageDivider2(midGradientColor: midGradientColor, value1: value1, value2: value2, value3: value3, label: label)
    ...
    @objc dynamic public class func imageOfPowerSupply(topGradientColor: UIColor = UIColor(red: 0.929, green: 0.520, blue: 0.520, alpha: 1.000), value1: String = "11.1K", value2: String = "22.2K", value3: String = "33.3K", label: String = "Maraschino") -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 380, height: 202), false, 0)
            ResistorImage.drawPowerSupply(topGradientColor: topGradientColor, value1: value1, value2: value2, value3: value3, label: label)
    ...
    @objc dynamic public class func imageOfPowerSupply2(midGradientColor: UIColor = UIColor(red: 0.719, green: 0.719, blue: 1.000, alpha: 1.000), value1: String = "11.1K", value2: String = "22.2K", value3: String = "33.3K", label: String = "Maraschino") -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 380, height: 249), false, 0)
            ResistorImage.drawPowerSupply2(midGradientColor: midGradientColor, value1: value1, value2: value2, value3: value3, label: label)
    ...
    @objc dynamic public class func imageOfGradientButton(selectedGradientColor: UIColor = UIColor(red: 0.288, green: 0.923, blue: 0.352, alpha: 1.000)) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 130, height: 40), false, 0)
            ResistorImage.drawGradientButton(selectedGradientColor: selectedGradientColor)

        let imageOfGradientButton = UIGraphicsGetImageFromCurrentImageContext()!.resizableImage(withCapInsets: UIEdgeInsets(top: 10, left: 10, bottom: 10, right: 10), resizingMode: .stretch)
        UIGraphicsEndImageContext()
