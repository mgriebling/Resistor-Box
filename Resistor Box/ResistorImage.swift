...
public class ResistorImage : NSObject {
    ...
    @objc dynamic public class func drawResistorCollection(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 86, height: 59), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 86, height: 59), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        ...
        //// Symbol 2 Drawing
        context.saveGState()
        context.translateBy(x: 2, y: 18.5)
        context.scaleBy(x: 0.5, y: 0.5)
        ...
        ResistorImage.drawSingleResistor(frame: CGRect(origin: .zero, size: symbol2Rect.size), resizing: .stretch)
        context.restoreGState()
        ...
        ResistorImage.drawSingleResistor(frame: CGRect(origin: .zero, size: symbol3Rect.size), resizing: .stretch)
        context.restoreGState()
